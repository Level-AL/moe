...
//						0		 1			2		  3			 4
String domains[] = {"Oracle", "Amazon", "Github", "Walmart", "techcircle"};
...
//			System.out.println(getRandomValueFromAnArray(domains));
	...
	String userName = "john" + random.nextInt(100000000);
...
String email = userName + "@" + getRandomValueFromAnArray(domains)+ ".com";
	...
	public static String getRandomEmail () {
		Random random = new Random();
String domains[] = {"Oracle", "Amazon", "Github", "Walmart", "techcircle", "Costco"};
		String userName = "john" + random.nextInt(100000000);
//		System.out.println(userName);
