...
//		System.out.println(nameInRegularFormat(firstName));
//		System.out.println(nameInRegularFormat(lastName));
		
	String output = nameInRegularFormat(firstName) + 
				" "	+ nameInRegularFormat(lastName);
		
	System.out.println(output);
	
	System.out.println(nameInRegularFormat("AAAAAAABBBBBCCCCC"));
...
public static boolean isPalendorm (String str) {
	return false;
